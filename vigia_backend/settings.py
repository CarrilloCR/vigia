...
ROOT_URLCONF = 'vigia_backend.urls'
...
WSGI_APPLICATION = 'vigia_backend.wsgi.application'
...
STRIPE_PRICE_PROFESIONAL = os.getenv('STRIPE_PRICE_PROFESIONAL', '')
